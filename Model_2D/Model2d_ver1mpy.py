...
"""
Packages
    matplotlib.pyplot : library for visualization discribing charts
    seaborn : library for visualization depending on matplotlib
    pandas : library written for data manipulation and analysis.
    tellurium : Python Environment for Reproducible Dynamical Modeling of Biological Networks
    roadrunner : looping testrunner
    skimage : library that collects algorithms related to image processing
    sys.exit : generate SystemExit that terminate script

Technical terms
    append : operation to add data
    enumerate : allows you to keep track of the number of iterations (loops) in a loop

Diagram
    contour : outside line
    rad,radius : half diameter
    ver,vertex,vertices : Choten
    ridge : 
"""
...
def get_neib_mx(points, cutoff=55):
    ...
    '''
    """note
    Want to return adjacency matrix
    1 generate matrix that all 0 
    2
    """
